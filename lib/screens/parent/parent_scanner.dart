  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: const AppHeader(
          title: "Scan Child QR / مسح QR الطفل",
      ...
      body: Stack(
        children: [
                    ...
                    if (data['type'] == 'child_link') {
                      ...
                      if (mounted) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                              content: Text(
                                  "Child linked successfully! / تم ربط الطفل بنجاح!"),
                    ...
                    if (lastErrorTime == null ||
                      ...
                      if (mounted) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                              content:
                                  Text("Invalid QR code. / كود QR غير صالح."),
          ...
          Positioned(
            ...
            right: 0,
            child: const Text(
              "Center the Child's QR code in the frame / حط كود QR بتاع الطفل في المنتصف",
